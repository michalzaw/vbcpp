...
class GraphicsManager
{
    ...
    public:
        ...
        MultiRenderObject* addMultiRenderObject(RenderObject* object); //Model* model = NULL);
        ...
        MirrorComponent*addMirrorComponent(const std::string& name, float width, float height, float renderingDistance, float refreshDistance);
        ...
        SkeletalAnimationComponent* addSkeletalAnimation(RAnimation* animation, RAnimation* animation2 = nullptr);
